...
class NotificationsLandlordView extends GetView<LandlordController> {
  const NotificationsLandlordView({super.key});
                ...
                child: ListTile(
                  ...
                  leading: Container(
                    ...
                    child: Icon(
                      ...
                      color:
                          controller.getActivityColor(activity['loai'] ?? ''),
                      size: 24,
                    ),
                  ),
                  title: Text(
                      ...
                      Text(
                        activity['ngayTao'] != null
                            ? DateFormat('dd/MM/yyyy HH:mm').format(
                                (activity['ngayTao'] as Timestamp).toDate())
                            : 'Vừa xong',
                        style: TextStyle(
                          fontSize: 12,
