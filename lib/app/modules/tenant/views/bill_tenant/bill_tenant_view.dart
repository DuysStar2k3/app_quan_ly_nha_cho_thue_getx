...
import 'bill_tenant_details_view.dart';

class BillTenantView extends GetView<BillTenantController> {
  const BillTenantView({super.key});
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              ...
              child: InkWell(
                onTap: () => Get.to(() => BillTenantDetailsView(bill: bill)),
                borderRadius: BorderRadius.circular(12),
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          if (bill.trangThai == 'chuaThanhToan')
                            ElevatedButton(
                              onPressed: () =>
                                  _showPaymentMethodDialog(bill.id),
