...
import '../../../landlord/views/settings_landlord_view/controller/edit_profile_controller.dart';

class EditProfileTenantView extends GetView<EditProfileController> {
  EditProfileTenantView({super.key});
